...
exports.startMining = void 0;
const wait_1 = require("../utils/actions/wait");
const startMining = (fleet, resourceName, time) => __awaiter(void 0, void 0, void 0, function* () {
    // action starts
    console.log(`\nStart mining ${resourceName}...`);
    // data
    // ...
    // instruction
    const ix = yield fleet.ixStartMining(resourceName);
